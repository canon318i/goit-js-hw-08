...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a="feedback-form-state",l=document.querySelector(".feedback-form");function s(){try{let t=JSON.parse(localStorage.getItem(a));return t||(t={email:"",message:""}),l.elements.email.value=t.email,void(l.elements.message.value=t.message)}catch(e){return console.log("Set state error: ",e.message),l.elements.email.value="",void(l.elements.message.value="")}}function m(){localStorage.setItem(a,JSON.stringify({email:l.elements.email.value,message:l.elements.message.value}))}function r(e){e.preventDefault();const t={email:l.elements.email.value,message:l.elements.message.value};return t.email&&t.message?(localStorage.removeItem(a),e.currentTarget.reset(),console.log(t),t):alert("Empty fields are not allowed!!!")}s(),l.addEventListener("input",(0,e.default)(m,1e3)),l.addEventListener("submit",r);
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.7aa6ed56.js.map