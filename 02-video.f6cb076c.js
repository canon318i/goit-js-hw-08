...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const r="videoplayer-current-time",o=document.querySelector("#vimeo-player"),l=new Vimeo.Player(o);let a=localStorage.getItem(r);a||(a=0),l.setCurrentTime(a),l.on("timeupdate",(0,e.default)(({seconds:e})=>{localStorage.setItem(r,Math.round(e))},1e3));
},{"lodash/throttle":"Ywd4"}]},{},["iiAF"], null)
//# sourceMappingURL=/goit-js-hw-08/02-video.f6cb076c.js.map