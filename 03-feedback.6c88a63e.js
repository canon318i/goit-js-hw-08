...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a="feedback-form-state",s=document.querySelector(".feedback-form");function l({email:e,message:t}){s.elements.email.value=e,s.elements.message.value=t}function r(){try{let t=JSON.parse(localStorage.getItem(a));return t||(t={email:"",message:""}),t}catch(e){return console.log("Set state error: ",e.message),{email:"",message:""}}}function m(){localStorage.setItem(a,JSON.stringify({email:s.elements.email.value,message:s.elements.message.value}))}function n(e){e.preventDefault();const t={email:s.elements.email.value,message:s.elements.message.value};return t.email&&t.message?(localStorage.removeItem(a),e.currentTarget.reset(),console.log(t),t):alert("Empty fields are not allowed!!!")}l(r()),s.addEventListener("input",(0,e.default)(m,1e3)),s.addEventListener("submit",n);
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.6c88a63e.js.map