...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const r=document.querySelector("iframe"),o=new Vimeo.Player(r);let u=localStorage.getItem("videoplayer-current-time");u||(u=0),o.setCurrentTime(u),o.on("timeupdate",(0,e.default)(()=>{o.getCurrentTime().then(e=>{localStorage.setItem("videoplayer-current-time",Math.round(e))})},1e3));
},{"lodash/throttle":"Ywd4"}]},{},["iiAF"], null)
//# sourceMappingURL=/goit-js-hw-08/02-video.90f3b1e3.js.map