...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a=document.querySelector(".feedback-form"),s=a.querySelector('[type="submit"]');function l({email:e,message:t}){a.elements.email.value=e,a.elements.message.value=t}function r(){try{let t=JSON.parse(localStorage.getItem("feedback-form-state"));return t||(t={email:"",message:""}),t}catch(e){return console.log("Set state error: ",e.message),{email:"",message:""}}}function m(){localStorage.setItem("feedback-form-state",JSON.stringify({email:a.elements.email.value,message:a.elements.message.value}))}function n(){event.preventDefault();const e={email:a.elements.email.value,message:a.elements.message.value};return localStorage.removeItem("feedback-form-state"),a.reset(),console.log(e),e}l(r()),a.addEventListener("input",(0,e.default)(m,1e3)),s.addEventListener("click",n);
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.891ddc46.js.map