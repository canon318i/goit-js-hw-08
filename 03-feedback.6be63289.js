...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a=document.querySelector(".feedback-form");function s({email:e,message:t}){a.elements.email.value=e,a.elements.message.value=t}function l(){try{let t=JSON.parse(localStorage.getItem("feedback-form-state"));return t||(t={email:"",message:""}),t}catch(e){return console.log("Set state error: ",e.message),{email:"",message:""}}}function m(){localStorage.setItem("feedback-form-state",JSON.stringify({email:a.elements.email.value,message:a.elements.message.value}))}function r(e){e.preventDefault();const t={email:a.elements.email.value,message:a.elements.message.value};return t.email&&t.message?(localStorage.removeItem("feedback-form-state"),a.reset(),console.log(t),t):alert("Empty fields are not allowed!!!")}s(l()),a.addEventListener("input",(0,e.default)(m,1e3)),a.addEventListener("submit",r);
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.6be63289.js.map